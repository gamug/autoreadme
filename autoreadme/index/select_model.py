...
from autoreadme.types import LLMModelDetails, LLMModels, Priority


def get_max_prompt_length(prompts: List[str], model: LLMModels) -> int:
    """Get Max Prompt Length"""
    encoding = get_llm_encoder(model)
...
def select_model(
    ...
    if priority == Priority.COST:
        ...
        for model_enum in [LLMModels.GPT52, LLMModels.GPT5, LLMModels.GPT4, LLMModels.GPT432k, LLMModels.GPT3]:
